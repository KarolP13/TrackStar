...
import PendingSummaryBar from "@/components/PendingSummaryBar";
...
export default function DashboardPage() {
  ...
  const [paymentRequestPromoter, setPaymentRequestPromoter] = useState<string | undefined>(undefined);
      ...
      <DashboardLayout>
        <div className="max-w-[100vw] overflow-hidden px-1 sm:px-0">
          <div className="animate-fade-in">
            ...
            <div className="flex items-center justify-between gap-4 mb-6 sm:mb-8">
              ...
              <div className="hidden sm:flex items-center gap-2">
                ...
                <button
                  onClick={() => { setPaymentRequestPromoter(undefined); setPaymentRequestOpen(true); }}
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-border-light bg-surface hover:bg-surface-hover text-text-secondary text-sm font-medium transition-all"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <>
                ...
                <div className="mb-3">
                  <PendingSummaryBar
                    ...
                    filterPromoter="All"
                    onGenerateRequest={(promoterName) => {
                      setPaymentRequestPromoter(promoterName || undefined);
          ...
          <PaymentRequestModal
            ...
            onClose={() => { setPaymentRequestOpen(false); setPaymentRequestPromoter(undefined); }}
            promos={promos}
            preSelectedPromoter={paymentRequestPromoter}
            promoterPresets={profile?.promoterPresets || {}}
          />
