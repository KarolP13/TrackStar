...
export default function PromoTable({ promos, onEdit, onDelete, onDuplicate, onCancelSeries, onBulkUpdateStatus }: PromoTableProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            {/* Sidebar Action Panel (Select Mode) — Desktop */}
            {selectMode && selectedIds.size > 0 && (
                <>
                    {/* Desktop: sits in sidebar area */}
                    <div className="hidden md:flex fixed left-0 top-[180px] w-64 z-40 px-3 animate-fade-in">
                        <div className="w-full p-3 bg-surface/95 backdrop-blur-md border border-border-light rounded-xl shadow-lg space-y-2.5">
