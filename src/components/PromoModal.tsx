        ...
        <>
            ...
            <div className="fixed inset-0 z-50 pointer-events-none">
                <div className="pointer-events-auto fixed inset-0 md:inset-auto md:top-6 md:right-6 w-full md:w-[480px] h-[100dvh] md:h-auto md:max-h-[85vh] md:rounded-2xl bg-background md:border border-border-light shadow-2xl flex flex-col overflow-hidden animate-slide-in">
                    {/* Header */}
                    <div className="relative flex items-center justify-center px-5 sm:px-6 pt-6 sm:pt-7 pb-4 sm:pb-5 border-b border-border-light safe-area-top">
                        <h2 className="text-lg font-semibold text-foreground">
                            {modalTitle}
                        </h2>
                        <button
                            onClick={onClose}
                            className="absolute right-5 sm:right-6 text-text-muted hover:text-text-secondary transition-colors p-1"
                        >
